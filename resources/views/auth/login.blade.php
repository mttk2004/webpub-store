        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-[480px]">
                ...
                <form class="space-y-6" action="/login" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember-me" class="ml-3 block text-sm leading-6 text-gray-900">Nhớ tôi</label>
                        </div>

                        <div class="text-sm leading-6">
                            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Quên mật
                                khẩu?</a>
                        </div>
                    </div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                <a href="{{ route('register') }}"
                    class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Đăng ký ngay</a>
            </p>
        </div>
    </div>
</body>
