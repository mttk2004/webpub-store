<div
  ...
  ease-out duration-400 transition-all opacity-0">
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center
    sm:p-0">
      <div id="modal-panel"
          class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl
          transition-all duration-300 ease-in-out sm:my-8 sm:w-full sm:max-w-lg translate-y-8 scale-75
          opacity-0">
    ...
    font-semibold text-white shadow-sm hover:bg-accent-500 sm:ml-3 sm:w-auto">
                Tìm kiếm
              </button>
              <button
                  type="button"
