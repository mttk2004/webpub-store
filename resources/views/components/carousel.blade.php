...
<div class="carousel relative w-full flex justify-center items-center">
  <div class="relative overflow-hidden w-9/12 sm:w-10/12 md:w-11/12 {{ $class }}">
    <div class="carousel-inner h-[29.4rem] transition-transform duration-500 ease-in-out">
      {{ $slot }}
    </div>
  </div>

  <button
      class="carousel-prev absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800
